...
st.subheader("Usage")
st.write("Once you have the application up and running, you can experiment with the two available models:")
st.markdown("[Random Model](https://huggingface.co/spaces/sagarsdesai/make_more)")
st.write("1. Select the 'Random Model' option from the navigation menu.")
st.write("2. Adjust any desired settings, such as the length of the generated name.")
...
st.write("2. Enter the desired starting characters for the name in the input field.")
st.write("3. Adjust any other settings as needed.")
